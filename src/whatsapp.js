...
//    العميل خلال ٢٤ ساعة) لازم تكون بقالب معتمد من Meta مسبقاً. القوالب المطلوبة لسكنّا:
//      - sakanna_listing_expiring  (تذكير المالك: إعلانه بدو تأكيد)
//      - sakanna_owner_dashboard   (رابط لوحة المالك لأول مرة)
//      - sakanna_institution_ack   (تأكيد استلام طلب مؤسسة)
 ...
 * @param {string} templateName - اسم القالب المعتمد من Meta (زي sakanna_listing_expiring)
